...
<body>
    <div class="sidebar-container">
        ...
        <ul class="sidebar-navigation">
          <li class="header">Welcome to Dinggols!!</li>
          <li>
      ...
      <div class="content-container">
        ...
        <div class="container-fluid">
          ...
          <div class="jumbotron">
           <div align="center"> <h1>Popular Dingolphies</h1></div>
            <div class="container mt-5">
    <div class="row d-flex justify-content-center">
        <div class="col-md-8">
        <?php
                                        $result=mysqli_query($conn,"SELECT * FROM confession c inner join tbluser u on c.user_id= u.user_id order by confession_id desc ");
