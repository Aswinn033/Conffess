...
<?php
  ...
  ?>
    ...
    <link rel="stylesheet" href="style2/follow.css">
</head>
...
<body>
    <div class="sidebar-container">
      ...
      <div class="content-container">
        ...
        <div class="container-fluid">
          ...
          <div class="jumbotron">
            <div align="center"><h2>Connections</h2></div>
    ...
    <div class="row d-flex justify-content-center">
     ...
     while($row=mysqli_fetch_array($result))
                ...
                $follower_details=mysqli_query($conn,"SELECT user_name, photo from tbluser where user_id='$fid'");
            ...
            <div class="card p-3">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="user d-flex flex-row align-items-center"> <img src="../upload/<?php echo $f_row['photo']; ?>" width="30" class="user-img rounded-circle mr-2"> <span><small class="font-weight-bold text-primary"></small> <small class="font-weight-bold"><?php echo $f_row['user_name'];?></small></span> </div> <small></small>
                </div>
                <div class="action d-flex justify-content-between mt-2 align-items-center">
                    <div class="reply px-4"> 
                  <button> <a href="remove_follower.php?f_id=<?php echo $row['follower_id'];?>">Disconnect</a></button><span class="dots"></span>&nbsp;<button><a href="#">Message</a></button></div>
...
<div class="container mt-5">
    <div class="row d-flex justify-content-center">
        ...
        <?php
                                        ...
                                        $result=mysqli_query($conn,"SELECT * FROM tblconnect where connector_id='$uid' and connection_status='accepted'");
                                        //$seen=mysqli_query($conn,"UPDATE notification set status='seen' where destination_id='$user'");
                                        //$result2=mysqli_query($conn,"SELECT * FROM confession c inner join tbluser u on c.user_id= u.user_id order by confession_id ");
                                        //die(mysqli_error($conn));
     ...
     while($row=mysqli_fetch_array($result))
            ...
            <div class="card p-3">
                ...
                <div class="action d-flex justify-content-between mt-2 align-items-center">
                    <div class="reply px-4"> 
                  <button> <a href="remove_follower.php?f_id=<?php echo $row['follower_id'];?>">Remove</a></button><span class="dots"></span>&nbsp;<button><a href="message.php?u_id=<?php echo $fid; ?>">Message</a></button></div>
                    <div class="icons align-items-center"> <i class="fa fa-star text-warning"></i> <i class="fa fa-check-circle-o check-icon"></i> </div>
                </div>
            </div>
            <!--<div class="card p-3 mt-2">
