...
<!-- notifications-->
<div class="jumbotron">
            <div align="center"><h1>Notifications</h1></div>
            <div class="container mt-5">
    <div class="row d-flex justify-content-center">
        <div class="col-md-8">
        <?php
        $user=$_SESSION['userid'];
        $sql=mysqli_query($conn,"SELECT * FROM notification where destination_id='$user'");
                  $r=mysqli_fetch_array($sql);
                  if($r==0)
                  {
                    echo '<div align="center">'; echo '<h3>No new notifications</h3>'; echo '</div>';
                  }
            
        else
        {
        
                                        $result=mysqli_query($conn,"SELECT * FROM notification where destination_id='$user'");
     ...
     while($row=mysqli_fetch_array($result))
            ...
            <div class="card p-3">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="user d-flex flex-row align-items-center"> <img src="../upload/bell.png" width="30" class="user-img rounded-circle mr-2"> <span><small class="font-weight-bold text-primary"></small> <small class="font-weight-bold"><?php echo $row['notification'];?></small></span> </div> <small></small>
                </div>
                <div class="action d-flex justify-content-between mt-2 align-items-center">
                    <div class="reply px-4"> 
                   <a href="view_confession.php?c_id=<?php echo $row['location_id']?>">View</a><span class="dots"></span>&nbsp;<?php echo $row['notification_date'];?></div>
