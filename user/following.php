    ...
    <div class="sidebar-container">
      ...
      <div class="content-container">
        ...
        <div class="container-fluid">
          ...
          <div class="jumbotron">
            <div align="center"><h2><a href="follow.php">Followers</a>&nbsp;|&nbsp;Following</h2></div>
            <div class="container mt-5">
    <div class="row d-flex justify-content-center">
        <div class="col-md-8">
        <?php
    
                                        $result=mysqli_query($conn,"SELECT * FROM tblfollow where follower_id='$uid' and follow_status='active'");
     ...
     while($row=mysqli_fetch_array($result))
            ...
            <div class="card p-3">
                ...
                <div class="action d-flex justify-content-between mt-2 align-items-center">
                  ...
                  <button> <a href="unfollow.php?f_id=<?php echo $row['user_id'];?>">Unfollow</a></button><span class="dots"></span>&nbsp;<button><a href="#">Message</a></button></div>
